<template>
  <div id="recetas" class="myTable">
    ...
    <!--HEAD DE LA PAGINA -->
    <vue-headful title="Recetas - Federación Tucumana de Mutuales"></vue-headful>
    ...
    <!-- ================ALTA RECETASS======================== -->
    <b-button class="mb-4 ml-2" v-b-modal.modal-alta @click="altaReceta()" title="Nueva Receta" style="color: white;">
      <v-icon dark>
        mdi-plus
      </v-icon>
      Nueva Receta
