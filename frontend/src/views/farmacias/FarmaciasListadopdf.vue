...
<script>
	...
	export default {
		...
		data() {
			return {
				fields: [
					//{ key: "cod_farmacia", label: "Codigo" },
					{ key: "matricula_farm", label: "Matricula" },
					{ key: "cuit", label: "CUIT" },
					{ key: "farmacia", label: "Farmacia" },
					{ key: "localidad", label: "Sucursal" },
					{ key: "direccion", label: "Direccion", sortable: true },
					{ key: "email", label: "Correo" },
					{ key: "tel_fijo", label: "Telefono Fijo" },
					{ key: "tel_celular", label: "Celular" },
